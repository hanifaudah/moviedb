...
# Main movie class
class movie:
    def __init__(self,id="",title="None",poster_url="None",score="None",date="None",overview="None"):
        self.id = id
        self.title = title
...
class movie_collection:
    ...
    def fetch(self,url):
        ...
        for i in results:
            self.results.append(movie(i["id"],i["title"],i["poster_path"],i["vote_average"],i["release_date"],i["overview"]))
...
#         print(i.id,i.title,i.poster,i.score,i.date,i.overview)
#         print()
